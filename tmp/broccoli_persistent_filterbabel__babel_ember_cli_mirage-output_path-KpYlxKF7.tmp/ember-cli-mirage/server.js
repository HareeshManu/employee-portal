  ...
  class Server {
    ...
    */
    ...
    _typeIsPluralForModel(typeOrCollectionName) {
      ...
      let isPlural = typeOrCollectionName === (0, _inflector.pluralize)(typeOrCollectionName);
      let isUncountable = (0, _inflector.singularize)(typeOrCollectionName) === (0, _inflector.pluralize)(typeOrCollectionName);
    ...
    _modelOrFactoryExistsForTypeOrCollectionName(typeOrCollectionName) {
      ...
      let type = (0, _inflector.singularize)(typeOrCollectionName);

      let modelExists = this.schema && this.schema.modelFor((0, _inflector.camelize)(type));
      let dbCollectionExists = this.db[(0, _normalizeName.toInternalCollectionName)(type)];
    ...
    _mapAssociationsFromAttributes(modelName, attributes, overrides = {}) {
      Object.keys(attributes || {}).filter(attr => {
        ...
        let isSelfReferentialBelongsTo = association && association instanceof _belongsTo.default && association.modelName === modelName;
